/// Computes a simple NSDF curve on the requested lag interval.
///
/// This intentionally favors readability over micro-optimisation so the
/// algorithm remains easy to tune during the next iterations.
