...
/// Finds positive local maxima in the NSDF curve.
...
/// Rejects weak or out-of-range peaks before final selection.
...
/// Selects the most credible candidate for V1.
///
/// The current heuristic follows a simple MPM-style rule:
/// - find the strongest credible peak
/// - keep the earliest peak whose clarity is close enough to that maximum
///
/// This avoids locking onto small early harmonics while still favoring the
/// fundamental over later stronger overtones in guitar-like signals.
